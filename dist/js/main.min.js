import{R as d,A as n}from"./app.js";import{C as u,L as h,A as p,P as m,T as b,S as c}from"./performanceMonitor.js";const r={STORAGE_KEY:"rekonime.shortcutsAcknowledged",isModalOpen:!1,appRef:null,setApp(e){this.appRef=e},getApp(){return this.appRef},getCache(){return u},shortcuts:{global:{"?":{action:"showHelp",description:"Show keyboard shortcuts",scope:"Global"},"/":{action:"focusSearch",description:"Focus search box",scope:"Global"},Escape:{action:"closeModal",description:"Close modal or dropdown",scope:"Global"},b:{action:"goToBookmarks",description:"Go to bookmarks page",scope:"Global"},f:{action:"openFilters",description:"Open filter panel",scope:"Global"},s:{action:"toggleSettings",description:"Open settings",scope:"Global"},r:{action:"surpriseMe",description:"Surprise me (random anime)",scope:"Global"},h:{action:"goHome",description:"Go to home / clear filters",scope:"Global"}},modal:{ArrowLeft:{action:"previousAnime",description:"Previous anime",scope:"Detail Modal"},ArrowRight:{action:"nextAnime",description:"Next anime",scope:"Detail Modal"}}},init(){document.addEventListener("keydown",e=>this.handleKeydown(e)),this.showFirstTimeHint()},showFirstTimeHint(){if(!(typeof window>"u"))try{if(this.getCache().getRaw(this.STORAGE_KEY,{validate:!0}))return;setTimeout(()=>{const t=document.createElement("div");t.className="keyboard-hint",t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.innerHTML=`
