...
const MetricGlossary = {
    ...
    definitions: {
        retentionScore: {
            title: 'Finish Confidence (0-100)',
            shortDesc: 'Estimated likelihood that viewers keep watching through the series',
            fullDesc: 'Estimates how likely you are to keep watching and finish the series without dropping off. Based on episode-by-episode scoring patterns.',
            components: [
