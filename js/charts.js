...
const Charts = {
  ...
  getMetricConfig(sortKey) {
    const metrics = {
      ...
      retention: { key: 'retentionScore', label: 'Finish Confidence', max: 100, suffix: '%', lowerIsBetter: false },
  ...
  getMetricForProfile(profile) {
    ...
    return metrics[profile] || { key: 'retentionScore', label: 'Finish Confidence', max: 100, suffix: '%' };
  },
